...
class GameContainer extends egret.DisplayObjectContainer{
    ...
    private bg:BgMap;
    private mainbg: egret.Bitmap;
    private btnStart:Button;
    private endbitmap: egret.Bitmap;
    private myFighter:Airplane;
    private bhFighter1: Airplane;
    private bhFighter2: Airplane;
    private BOSS: Airplane;
    private bgmusic: egret.Sound;
    private bgmusic2: egret.Sound;
    private Bulletmusic: egret.Sound;
    private Bullet2music: egret.Sound;
    private explomusic: egret.Sound;
    private getpowermusic: egret.Sound;
    private waringmusic: egret.Sound;
    private diemusic: egret.Sound;
   private  channel: egret.SoundChannel;
    ...
    /**触发创建陨石的间隔*/
    private stonesTimer:egret.Timer = new egret.Timer(5000);
    /**进入boss的计时器*/
    private bosscomingTimer: egret.Timer = new egret.Timer(25000,3);
    private delExplo:Explo[] = [];
    /**成绩显示*/
  //  private scorePanel:ScorePanel;
    ...
    private createGameScene():void{
        ...
        var texture:egret.Texture = RES.getRes("startbutton_png");
    ...
    private createBulletHandler(evt:egret.Event):void{
        ...
        {
            var bhFighter: Airplane = evt.target;
            bullet = Bullet.produce("mybullet_norm");
            bullet.anchorOffsetX = bullet.width / 2;
            bullet.anchorOffsetY = bullet.height / 2;
    ...
    private createEnemyFighter(evt:egret.TimerEvent):void{
        ...
        switch(num) {
            ...
            case 4:
                ...
                var enemyFighter:Airplane = Airplane.produce(texture,800,planetype);
       ...
       //创建陨石
           private createStone(evt:egret.TimerEvent):void{
            var stone:Stone= Stone.produce("store"); 
    ...
    private gameViewUpdate(evt:egret.Event):void{
        ...
        //    陨石运动    
        var thestone: Stone;
        var stonesCount: number = this.stones.length;
        ...
        //  能量运动   
        var thePower:Power;
        var powersCount: number = this.powers.length;
        var center:number=this.stageW/2;
        ...
        var enemyBulletsCount:number = this.enemyBullets.length;
        var stonesCount:number = this.stones.length;
        var powerCount:number = this.powers.length;
        //将需消失的子弹和飞机和爆炸和陨石记录
